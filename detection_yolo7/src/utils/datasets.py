...
bridge = CvBridge() # ROS image 메세지와 OpenCV 이미지 객체 간 변환을 위한 객체 생성
def img_callback(data):
    global cv_image # 다른 def 에서 사용하기 위한  전역변수
    cv_image = bridge.imgmsg_to_cv2(data, "bgr8")

rospy.Subscriber("stereo/left_image", Image, img_callback)
